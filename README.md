...
> "La seguridad no es un producto, es un proceso. Aprende, prueba y protege."

<div align="center">

Autodidacta en **ciberseguridad ofensiva**, enfocado en **pentesting web, enumeración de vulnerabilidades, OSINT y desarrollo de herramientas**.
...
Mi objetivo es **seguir aprendiendo y desarrollándome dentro del área de la ciberseguridad**, especialmente en el ámbito del **Red Team**.

A medida que avanzo en mi formación, también intento **documentar y compartir conocimientos**, creando contenido educativo y write‑ups que puedan ayudar a otros que estén empezando en este campo.
...
Actualmente estoy practicando **Python orientado a scripting**, con el objetivo de desarrollar pequeñas herramientas que ayuden en tareas de:

* Automatización
* Enumeración
* Análisis de información

Además, vengo del mundo del **desarrollo web**, por lo que también disfruto creando aplicaciones y páginas web para **laboratorios, proyectos personales, blogs o pequeñas empresas**.
...
Intento compartir con frecuencia mis avances, aprendizajes y recursos relacionados con **ciberseguridad, pentesting y sistemas Linux**.

| Plataforma | Contenido                                                      |
| ---------- | -------------------------------------------------------------- |
| LinkedIn   | Publicaciones sobre aprendizaje en ciberseguridad y tecnología |
| GitHub     | Documentación técnica, proyectos y write‑ups                   |

---

# 🧠 Plataformas donde practico Pentesting

Gran parte de mi aprendizaje se basa en **laboratorios prácticos y plataformas CTF**.

| Plataforma    | Qué practico                                                              |
| ------------- | ------------------------------------------------------------------------- |
| TheHackerLabs | Máquinas vulnerables para practicar explotación y escalada de privilegios |
| TryHackMe     | Laboratorios guiados de Red Team y seguridad ofensiva                     |
| Docker Labs   | Laboratorios de vulnerabilidades web en entornos controlados              |
| OverTheWire   | Retos centrados en Linux, enumeración y fundamentos de seguridad          |

---

# 🔍 Metodología de Pentesting que practico

En los laboratorios intento seguir una metodología similar a la utilizada en entornos profesionales:
